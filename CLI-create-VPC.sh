...
#
# SINOPSIS
# Automatiza la creación de una VPC IPv4 personalizada, teniendo tanto una pública como una
# subred privada y una puerta de enlace NAT.
#
# DESCRIPCIÓN
# Este script de shell aprovecha la interfaz de línea de comandos de AWS (AWS CLI) para
# crear automáticamente una VPC personalizada. El script asume que la CLI de AWS está
# instalado y configurado con las credenciales de seguridad necesarias.
#
#==============================================================================
#
# NOTES
...
SUBNET_PUBLIC_CIDR="10.211.1.0/24"
SUBNET_PUBLIC_AZ="us-east-1a"
SUBNET_PUBLIC_NAME="10.211.1.0 - us-east-1a"

SUBNET_PUBLIC_CIDR2="10.211.3.0/24"
SUBNET_PUBLIC_AZ2="us-east-1a"
SUBNET_PUBLIC_NAME2="10.211.3.0 - us-east-1b"

SUBNET_PRIVATE_CIDR="10.211.2.0/24"
SUBNET_PRIVATE_AZ="us-east-1a"
SUBNET_PRIVATE_NAME="10.211.2.0 - us-east-2a"
CHECK_FREQUENCY=5
#
#==============================================================================
